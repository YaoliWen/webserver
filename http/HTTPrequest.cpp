...
bool HTTPrequest::parse(Buffer& buff) {
    // std::cout<<"HTTPrequest parse start:"<<std::endl;
    const char CRLF[] = "\r\n";
    ...
    while(buff.readableBytes() && state_ != FINISH) {
        ...
        case REQUEST_LINE:
            ...
            if(!parseRequestLine_(line)) {
                // std::cout<<"parseRequestLine false"<<line<<std::endl;
                return false;
            }
            // std::cout<<"parseRequestLine true"<<line<<std::endl;
            parsePath_();
            break;    
        case HEADERS:
...
bool HTTPrequest::parseRequestLine_(const std::string& line) {
    ...
    // std::cout<<"start regex patten"<<std::endl;
    std::regex patten("^([^ ]*) ([^ ]*) HTTP/([^ ]*)$");
    // std::cout<<"regex patten"<<std::endl;
    std::smatch subMatch;
    // std::cout<<"smatch subMatch"<<std::endl;
